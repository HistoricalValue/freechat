             ...
             'Every command name can be abbreviated to an unambiguous minimum.',
                ...
                'general' => HelpModule::new('general',
                  ...
                  ['The general idea',
                   ...
                   'to enter input. This happens with the pair of commands ',
                   '/silence and /speak, or their switch, //. The UI begins',
                   'in /silence mode.',
                   '',
                   'The user can also cancel the next line that would be',
                   'entered by sending a interrupt signal to the interface',
